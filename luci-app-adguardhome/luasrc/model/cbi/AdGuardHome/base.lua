...
o.datatype="port"
o.optional = false
o.description = translate("<input type='button' style='width:210px; border-color:Teal; text-align:center;padding: .75rem 1rem; font-weight:bold;color:Green;background:#f36c21;' value='AdGuardHome Web:" .. httpport .. "' onclick=\"window.open('http://'+window.location.hostname+':" .. httpport .. "')\"/>")
