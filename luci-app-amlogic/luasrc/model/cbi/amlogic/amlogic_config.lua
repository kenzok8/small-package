...
kernel_tags = o:option(Value, "amlogic_kernel_tags", translate("Download tags of OpenWrt kernel:"))
kernel_tags.description = translate("Set the download tags of the kernel in the github.com repository in [Online Download Update].")
