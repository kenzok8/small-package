...
git clone --depth 1 https://github.com/kenzok78/webdav && mv -n webdav/*webdav ./ ; rm -rf webdav
...
svn co https://github.com/kenzok8/litte/trunk/luci-app-mosdns
svn co https://github.com/kenzok8/litte/trunk/mosdns
