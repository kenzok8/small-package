...
git clone --depth 1 https://github.com/kenzok8/wall && mv -n wall/* ./ ; rm -rf mosdns && rm -rf luci-app-ssr-plus && rm -rf luci-app-passwall && rm -rf luci-app-passwall2 && rm -rf wall
